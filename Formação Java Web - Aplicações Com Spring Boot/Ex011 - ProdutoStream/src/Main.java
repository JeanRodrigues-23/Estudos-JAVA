...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, Optional<Produto>> produtoMaisCaroCateg = produtos.stream()
                .collect(Collectors.groupingBy(Produto::getCategoria,
                        Collectors.maxBy(Comparator.comparing(Produto::getPreco))));

        System.out.println("Produto mais caro por categoria: " + produtoMaisCaroCateg);
        ...
        System.out.println("Soma do preço dos produtos por categoria: " + totalPorCategoria);
    }
}